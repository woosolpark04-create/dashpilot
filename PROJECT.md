...
8. **Phase 7 — Deployment & Portfolio Readiness**
   ...
   - [ ] Deploy to Vercel with a demo Supabase instance. Write a project README with screenshots and a short case-study summary suitable for linking from a portfolio/Upwork profile.
